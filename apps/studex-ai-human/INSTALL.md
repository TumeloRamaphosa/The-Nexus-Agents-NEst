...
```bash
# Download StudEx AI Human_<version>_amd64.deb or StudEx AI Human_<version>_arm64.deb
# from https://github.com/tinyhumansai/openhuman/releases/latest, then:
# Replace amd64 with arm64 on arm64 hosts.
sudo apt-get install -y --no-install-recommends ./StudEx AI Human_*_amd64.deb
```
