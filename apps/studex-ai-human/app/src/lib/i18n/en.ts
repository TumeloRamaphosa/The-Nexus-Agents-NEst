...
const en: TranslationMap = {
  ...
  'agentWorld.description':
    'Tiny.Place is a social network for AI agents. Use StudEx AI Human to interact, find and post jobs, trade, and grow together.',
  ...
  // Welcome page
  'welcome.logoAlt': 'StudEx AI Human',
  'welcome.title': 'Welcome to StudEx AI Human',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'Could not clear app data. Please quit and reopen StudEx AI Human, then try again.',
  ...
  'home.statusCoreUnreachable':
    "The StudEx AI Human core isn't responding. The background process may have crashed or failed to start.",
  ...
  'memory.health.remediation.auth_missing':
    'No embeddings credentials found. Log in to StudEx AI Human, or set up local Ollama embeddings in Connections → API keys → Embeddings.',
  ...
  'memory.health.remediation.storage_unavailable':
    "StudEx AI Human can't write to its memory storage — the disk or SD card appears to be failing, full, or read-only. Check the drive and free up space; memory processing resumes automatically once storage is writable again.",
  ...
  'rewards.localUnavailable':
    'Local login does not earn rewards, coupons, or referral credit. To earn rewards, log out and continue by signing in with an StudEx AI Human account.',
  ...
  // Onboarding
  'onboarding.welcome': "Hi. I'm StudEx AI Human.",
  ...
  'onboarding.finishDesc': "You're all set! Start using StudEx AI Human.",
  'onboarding.skip': 'Skip',
  'onboarding.getStarted': 'Get Started',

  // Onboarding: runtime-choice step (Cloud vs Custom)
  'onboarding.runtimeChoice.title': 'How would you like to run StudEx AI Human?',
  'onboarding.runtimeChoice.subtitle':
    'Pick how much StudEx AI Human manages for you. You can change this later in Settings.',
  'onboarding.runtimeChoice.cloud.title': 'Simple',
  'onboarding.runtimeChoice.cloud.tagline':
    'Use StudEx AI Human-hosted sign-in, model routing, search, and managed integrations.',
  ...
  'onboarding.runtimeChoice.custom.tagline':
    'Bring your own keys. Choose which services StudEx AI Human should call.',
  ...
  'onboarding.custom.defaultSubtitle': 'Let StudEx AI Human manage it for you.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'StudEx AI Human routes workloads through its managed backend by default. No keys, no setup.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'StudEx AI Human ships with managed STT/TTS providers that may send audio/text to hosted services.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'StudEx AI Human brokers OAuth and tool calls through a managed Composio workspace.',
  ...
  'onboarding.custom.search.subtitle': 'How StudEx AI Human searches the web on your behalf.',
  'onboarding.custom.search.defaultDesc':
    'StudEx AI Human uses a managed search proxy by default. No search API key needed.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'How StudEx AI Human generates vector embeddings for semantic memory search.',
  'onboarding.custom.embeddings.defaultDesc':
    'StudEx AI Human uses a managed embedding service. No API key needed.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Use StudEx AI Human-managed memory defaults. Vault path and sync health can still be reviewed later.',
  'onboarding.custom.vault.configureDesc':
    'Review vault ownership, run health checks, and tune memory controls now.',
  'onboarding.custom.vault.localDisabledReason':
    'Managed setup requires StudEx AI Human sign-in and is unavailable in local mode.',
  ...
  'onboarding.custom.memory.subtitle':
    'How StudEx AI Human remembers your context, preferences, and prior conversations.',
  'onboarding.custom.memory.defaultDesc':
    'StudEx AI Human manages memory storage and retrieval automatically. Nothing to set up.',
  ...
  'misc.beta':
    'StudEx AI Human is in early beta. Feel free to share feedback or report any bugs you run into — every report helps us ship faster.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Help improve StudEx AI Human by sharing privacy-limited crash reports and usage events, including a stable account ID and app version metadata. Messages, wallet keys, API keys, and session tokens are never collected.',
  ...
  'privacy.autoHandoffMeetDesc':
    "When a Google Meet call ends, StudEx AI Human's orchestrator can read the transcript and may take actions like drafting messages, scheduling follow-ups, or posting summaries to your connected Slack workspace. Off by default.",
  ...
  'settings.core.applyRestartNote': 'Saving restarts StudEx AI Human to reconnect.',
  ...
  'settings.search.menuDesc':
    'Default to StudEx AI Human-managed search or wire up your own provider with an API key.',
  'settings.search.description':
    "Pick the search engine the agent uses, or disable search tools entirely. Managed uses StudEx AI Human's backend (no setup). Parallel, Brave, and Querit run direct from your machine using your API key.",
  'settings.search.engineAria': 'Search engine',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc':
    'Remove search tools from the agent context and available tool list.',
  'settings.search.engineManagedLabel': 'StudEx AI Human Managed',
  'settings.search.engineManagedDesc':
    'Default. Routed through the StudEx AI Human backend — no API key required.',
  'settings.search.localManagedUnavailable':
    'StudEx AI Human Managed search is not available for local users. Add your own Parallel, Brave, or Querit API key to enable web search.',
  ...
  'settings.embeddings.requiresSignIn': 'Requires StudEx AI Human sign-in',
  'settings.embeddings.managedLoginRequired':
    'Managed embeddings require StudEx AI Human sign-in. Sign in to use the StudEx AI Human backend.',
  'settings.embeddings.managedBannerIntro':
    'Managed embeddings route through the StudEx AI Human backend and require an StudEx AI Human account session.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Sign in again to refresh your StudEx AI Human session, or switch to a local or bring-your-own embeddings provider.',
  ...
  'devices.betaText':
    'This feature is currently in beta. Pair iOS phones with this StudEx AI Human to use them as a remote client.',
  ...
  'devices.emptyState': 'Scan a QR code on your iPhone to connect it to this StudEx AI Human session.',
  ...
  'devices.pairModal.instructions': 'Open the StudEx AI Human app on your iPhone and scan this code.',
  ...
  'mcp.connectAuth.oauthHint':
    'This server uses OAuth. Sign in through your browser to authorize StudEx AI Human.',
  ...
  'autonomy.maxActionsHelp':
    'Maximum tool actions an agent can run per rolling hour. New value applies to your next chat. Cron jobs and channel listeners keep their current limit until you restart StudEx AI Human.',
  ...
  'settings.tools.chooseCapabilities':
    'Choose which capabilities StudEx AI Human can use on your behalf.',
  ...
  'voice.providers.cloudWhisperProxy': 'StudEx AI Human (Managed)',
  ...
  'voice.providers.cloudElevenLabsProxy': 'StudEx AI Human (Managed)',
  ...
  'voice.providers.chip.cloud': 'StudEx AI Human (Managed)',
  'voice.providers.chip.cloudAria': 'StudEx AI Human managed provider is always enabled',
  ...
  'pttSettings.description':
    "Hold a key to talk to StudEx AI Human while you're in another app. Release the key to send; StudEx AI Human speaks the reply if 'Speak agent replies' is on.",
  ...
  'pttSettings.errorAccessibility':
    'macOS needs Accessibility permission for this shortcut. Open System Settings → Privacy & Security → Accessibility and enable StudEx AI Human.',
  ...
  'pttSettings.errorUnsupportedWayland':
    "Wayland sessions don't support global shortcuts in StudEx AI Human yet — switch to an X11 session or use the in-app dictation toggle.",
  ...
  'chat.superContext.hint':
    'Super Context allows StudEx AI Human to gather and prepare context from all the data it has access to so that it can deliver a highly relevant answer. Super Context is in early beta.',
  ...
  'chat.attachment.videoNotSupported':
    'This model can’t read videos. You can use the StudEx AI Human Reasoning tier to attach your video.',
  ...
  'chat.attachment.imageNotSupported':
    'This model can’t read images. You can use the StudEx AI Human Reasoning tier to attach your image.',
  ...
  'vaultHealth.writableLabel': 'Vault is writable by StudEx AI Human',
  'vaultHealth.writableRecovery':
    'StudEx AI Human cannot write to this vault yet. Grant write permissions and refresh.',
  ...
  'memoryData.workspaceVaultDesc':
    'StudEx AI Human writes generated memory notes to memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indexes, queue state, and summaries are managed by StudEx AI Human to keep recall and sync healthy.',
  ...
  'backend.cloudDescription':
    'Fast, powerful models routed through the StudEx AI Human backend. Ready to use immediately.',
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription': 'StudEx AI Human needs a runtime to think. Pick where it should live.',
  'bootCheck.webDescription':
    'On the web, StudEx AI Human connects to a runtime you control. Drop in its URL and auth token below, or grab the desktop app to run one right on your machine.',
  ...
  'bootCheck.legacyDescription':
    'A separately-installed StudEx AI Human daemon is already running on this device. We need to clear it out before the built-in runtime can take over.',
  ...
  'bootCheck.portConflictBody':
    "Another process is using the network port StudEx AI Human needs. We'll try to fix this automatically.",
  ...
  'bootCheck.portConflictOwner': '{name} (PID {pid}) is using the network port StudEx AI Human needs.',
  ...
  'composio.expiredDescription':
    'Reconnect to re-enable {name} tools. StudEx AI Human will keep this integration unavailable until you refresh OAuth access.',
  ...
  'app.openhumanLink.accounts.intro':
    'Connect your apps to give StudEx AI Human access to your accounts.',
  ...
  'app.openhumanLink.discord.intro': 'Join the StudEx AI Human community on Discord.',
  'app.openhumanLink.discord.openInvite': 'Open invite link',
  'app.openhumanLink.discord.perk1': 'Early access to new features',
  'app.openhumanLink.discord.perk2': 'Connect with other StudEx AI Human users',
  ...
  'app.openhumanLink.notifications.permissionOff':
    'Notification permission is off. Enable StudEx AI Human in System Settings → Notifications, then retry.',
  'app.openhumanLink.notifications.triggerFailed':
    'StudEx AI Human could not trigger a system notification. Check OS notification settings and retry.',
  'app.openhumanLink.notifications.welcomeBody':
    'You will get pings here when something needs your attention.',
  'app.openhumanLink.notifications.welcomeTitle': 'StudEx AI Human is good to go',
  ...
  'app.openhumanLink.notifications.blockedStep2': 'Go to Notifications → StudEx AI Human',
  'app.openhumanLink.notifications.blockedStep3': 'Enable Allow Notifications',
  'app.openhumanLink.notifications.intro': 'Allow StudEx AI Human to send you notifications.',
  ...
  'app.openhumanLink.notifications.sent':
    "Test notification sent. If you didn't receive it, go to System Settings → Notifications → StudEx AI Human, turn on Allow Notifications, and set Banner Style to Persistent.",
  ...
  'app.routeLoading.initializing': 'Initializing StudEx AI Human...',
  ...
  // Auth mode labels
  'channels.authMode.managed_dm': 'Login with StudEx AI Human',
  ...
  'channels.discord.authMode.oauth.description':
    'Install the StudEx AI Human bot to your Discord server via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Link your personal Discord account to the StudEx AI Human bot.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Message the StudEx AI Human Telegram bot directly.',
  ...
  'iosPair.error.invalidQr':
    'Invalid QR code. Make sure you are scanning an StudEx AI Human pairing code.',
  ...
  'iosPair.instructions':
    'Open StudEx AI Human on your desktop, go to Settings > Devices, and tap "Pair phone" to show the QR code.',
  'iosPair.retryScan': 'Retry scan',
  'iosPair.scanQrCode': 'Scan QR code',
  'iosPair.scannerOpening': 'Scanner opening...',
  'iosPair.step.openDesktop': 'Open StudEx AI Human on desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "StudEx AI Human's own agent permissions are controlled below as read, write, and admin toggles.",
  ...
  'composio.triggers.sessionExpired':
    'Your StudEx AI Human session expired. Sign in again to load triggers.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    "StudEx AI Human doesn't have permission to do this yet.",
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'A service StudEx AI Human needs is temporarily unavailable.',
  'conversations.toolFailure.serviceUnavailable.next':
    'StudEx AI Human will try again shortly — no action needed.',
  ...
  'conversations.toolFailure.modelConnection.cause': "StudEx AI Human couldn't reach the AI model.",
  'conversations.toolFailure.modelConnection.next':
    'Check your connection or model settings; StudEx AI Human will retry.',
  'conversations.toolFailure.timeout.cause': 'The action took too long and was stopped.',
  'conversations.toolFailure.timeout.next':
    'StudEx AI Human will try again, or you can retry it manually.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    "Ask again to run it — StudEx AI Human won't retry it on its own.",
  ...
  'daemon.serviceBlockingGate.title': 'StudEx AI Human core is unavailable',
  ...
  'intelligence.diagram.imageAlt': 'Latest generated StudEx AI Human architecture diagram',
  ...
  'tinyplaceOrchestration.master.preview': 'Direct coordination between you and StudEx AI Human.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Message StudEx AI Human…',
  ...
  'overlay.ariaOrb': 'StudEx AI Human overlay',
  ...
  'rewards.community.activityStreakHint': 'Consecutive days you were active on StudEx AI Human.',
  ...
  'rewards.community.heroTitle': 'Earn rewards with StudEx AI Human',
  ...
  'rewards.community.roleClaimDesc':
    'You unlocked Discord roles but have not joined the StudEx AI Human server yet. Join to get them assigned automatically.',
  ...
  'settings.ai.openhumanDefault': 'StudEx AI Human (default)',
  ...
  'settings.ai.defaultProviderName': 'StudEx AI Human',
  ...
  'settings.ai.routing.managedDesc':
    'StudEx AI Human will run all inference in the cloud, choose the best model for the task, optimize for cost, and keep the safest routing defaults.',
  'settings.ai.routing.managedMsg':
    'StudEx AI Human will handle all inference for every workload and automatically choose the best route for cost, quality, and security.',
  ...
  'settings.composio.confirmWarning':
    "Your existing integrations (Gmail, Slack, GitHub, etc. linked through StudEx AI Human) won't be visible — they live in the StudEx AI Human-managed Composio tenant.",
  ...
  'settings.composio.modeManaged': 'Managed (StudEx AI Human handles it for you)',
  'settings.composio.modeManagedDesc':
    'StudEx AI Human proxies tool calls through our backend (recommended). Auth is brokered; you never paste a Composio API key. Webhooks are fully routed.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'StudEx AI Human now treats Ollama as an external inference runtime. Start your own Ollama server, pull the models you want, and point workload routing at it.',
  ...
  'settings.developerMenu.tools.desc':
    'Enable or disable capabilities StudEx AI Human can use on your behalf',
  ...
  'settings.developerMenu.mcpServer.desc': 'Configure external MCP clients to connect to StudEx AI Human',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'StudEx AI Human binary not found. If running from source, build with: cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'Let StudEx AI Human act on tiny.place on its own: on a schedule it finds worthwhile work — open bounties first — does what fits its skills, and acts from your identity. It runs unattended and can spend, so keep it on devnet while testing. Off by default.',
  ...
  'settings.mascot.characterDesc': 'Choose your StudEx AI Human character.',
  ...
  'settings.mascot.colorAria': 'StudEx AI Human color',
  ...
  'settings.mascot.libraryUnavailable': 'StudEx AI Human library unavailable',
  'settings.mascot.title': 'StudEx AI Human',
  'settings.mascot.loadingLibrary': 'Loading StudEx AI Human library…',
  'settings.mascot.loadDetailError': 'Could not load mascot.',
  'settings.mascot.loadLibraryError': 'Could not load mascot library.',
  'settings.mascot.localDefault': 'Local StudEx AI Human (default)',
  'settings.mascot.menuTitle': 'Mascot',
  'settings.mascot.menuDesc': 'Pick the mascot color used across the app',
  'settings.mascot.noCharacters': 'No StudEx AI Human characters are available yet',
  ...
  'settings.memoryWindow.description':
    'How much remembered context StudEx AI Human injects into every new agent run. Larger windows feel more aware of past conversations but use more tokens — and cost more — on every run.',
  ...
  'skills.meetingBots.bannerDesc':
    'StudEx AI Human joins calls silently and handles notes and follow-ups automatically.',
  'skills.meetingBots.bannerTitle': 'Send StudEx AI Human to your next meeting',
  'skills.meetingBots.busyTitle': 'StudEx AI Human is busy',
  'skills.meetingBots.comingSoon': 'coming soon',
  'skills.meetingBots.couldNotLeaveTitle': 'Couldn’t leave the meeting',
  'skills.meetingBots.couldNotStartTitle': 'Could not start StudEx AI Human',
  'skills.meetingBots.displayName': 'Display name',
  'skills.meetingBots.failedToStart': 'Failed to start StudEx AI Human.',
  'skills.meetingBots.joiningMessage': 'It should appear as a participant in a few seconds.',
  'skills.meetingBots.joiningTitle': 'StudEx AI Human is joining the meeting',
  'skills.meetingBots.meetingLink': 'Meeting link',
  'skills.meetingBots.modalAriaLabel': 'Send StudEx AI Human to a meeting',
  'skills.meetingBots.modalDesc':
    'StudEx AI Human will join as a silent participant and help with notes and follow-ups.',
  'skills.meetingBots.modalTitle': 'Send StudEx AI Human to a meeting',
  ...
  'skills.meetingBots.serverOverloaded':
    'StudEx AI Human is under heavy load right now. Please try again in a few minutes.',
  ...
  'skills.meetingBots.wakePhraseHint': 'Hey StudEx AI Human',
  ...
  'skills.meetingBots.history.runWithStudEx AI Human': 'Run with StudEx AI Human',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Let StudEx AI Human watch your connected calendar so it can auto-join or prompt for meetings based on the policies below. This is separate from meeting reminder notifications.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain is the memory graph: the place to inspect what StudEx AI Human knows and how ideas connect.',
  ...
  'settings.mascot.noCharactersAvailable': 'No StudEx AI Human characters are available yet',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Manage the Ollama process and model pulls outside StudEx AI Human, then rerun diagnostics.',
  ...
  'devOptions.menuToolsDesc': 'Enable or disable capabilities StudEx AI Human can use on your behalf',
  ...
  'harnessInit.subtitle': 'StudEx AI Human is preparing components it needs on first launch.',
  ...
  'harnessInit.failedMessage':
    'Some setup steps did not finish. You can retry, or continue — StudEx AI Human will use a built-in fallback.',
  'harnessInit.retry': 'Retry',
  'harnessInit.continueAnyway': 'Continue anyway',
  'harnessInit.runInBackground': 'Run in background',
  'harnessInit.backgroundHint': 'You can keep using StudEx AI Human while this finishes.',

  // Keyring consent & security
  'keyring.consent.title': 'Secure Storage Unavailable',
  'keyring.consent.description':
    'Your operating system keychain is not accessible. StudEx AI Human needs your permission to store secrets using local encrypted storage instead.',
