...
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/TumeloRamaphosa/SrudEx-Agents-Nest-Cloud-VM/main/apps/studex-ai-human/scripts/install.sh | bash
...
REPO="TumeloRamaphosa/SrudEx-Agents-Nest-Cloud-VM"
...
case "${OS_RAW}" in
  ...
  CYGWIN*|MINGW*|MSYS*)
    ...
    echo "  irm https://raw.githubusercontent.com/TumeloRamaphosa/SrudEx-Agents-Nest-Cloud-VM/main/apps/studex-ai-human/scripts/install.ps1 | iex"
    exit 1
    ;;
  *)
